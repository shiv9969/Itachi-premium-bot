...
PREMIUM_USERS = list(map(int, os.environ.get('PREMIUM_USERS', '6786151204 2121383171 7233360352 1525203313 6493123859 5825791537 7734363487 7330430532 1819012185 1878764624 892793307 5329284439').split()))
verify_dict = {}
