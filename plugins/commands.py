...
from database.users_chats_db import db, delete_all_referal_users, get_referal_users_count, get_referal_all_users, referal_add_user, add_referal_users
from info import *
...
async def start(client, message):
    ...
    if data.split("-", 1)[0] == "BATCH":
        ...
        if safari:
            ...
            if await add_referal_users(user_id):
