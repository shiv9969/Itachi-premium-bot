...
from utils import get_size, imdb, is_subscribed, get_poster, search_gagala, temp, get_settings, save_group_settings, get_shortlink, check_verification, get_token, stream_site, get_tutorial, get_text
        ...
        await query.edit_message_reply_markup(
            reply_markup=InlineKeyboardMarkup([[
                    ...
                    InlineKeyboardButton("🖥️ ꜱᴛʀᴇᴇᴍ 🖥️", url=online)
                              ...
                              InlineKeyboardButton("🌹 ʀᴇғғᴇʀ 🌹", url='https://t.me/narutossssbot?start=reffer'),
...
async def pm_text(bot, message):
    ...
    await message.reply_text(
         text=f"<b><a href='https://t.me/BoB_AreA'>Please Request your fav movies & series in our movies request group \n\n join the group and request whatever you want </a></b>",   
         reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("📚 ʀᴇǫᴜᴇsᴛ ʜᴇʀᴇ 📚", url=f"https://t.me/BoB_AreA")]])
    )
        ...
        if len(message.text) < 100:
            ...
            if not files:
                ...
                if settings["spell_check"]:
                    ai_sts = await message.reply('🤖 ᴘʟᴇᴀꜱᴇ ᴡᴀɪᴛ, ᴀɪ ɪꜱ ᴄʜᴇᴄᴋɪɴɢ ʏᴏᴜʀ ꜱᴘᴇʟʟɪɴɢ...')
