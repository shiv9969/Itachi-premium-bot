...
BOT_TOKEN = environ.get('BOT_TOKEN', "6649208003:AAFLZHWUMFxQKpkUzOW2f1OmNn8jA2rfAds")
...
reqst_channel = environ.get('REQST_CHANNEL_ID', "-1002106576609")
REQST_CHANNEL = int(reqst_channel) if reqst_channel and id_pattern.search(reqst_channel) else None
SUPPORT_CHAT_ID = int(support_chat_id) if support_chat_id and id_pattern.search(support_chat_id) else None
NO_RESULTS_MSG = is_enabled((environ.get("NO_RESULTS_MSG", 'True')), False)

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://mogo012:mogo012@cluster0.wkdapvy.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
