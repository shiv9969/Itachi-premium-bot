...
AUTH_CHANNEL = int(auth_channel_1) if auth_channel_1 and id_pattern.search(auth_channel_1) elif int(auth_channel_2) if auth_channel_2 and id_pattern.search(auth_channel_2) else None
