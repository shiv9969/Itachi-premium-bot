...
BOT_TOKEN = environ.get('BOT_TOKEN', "7162641937:AAGY71D-kSKemPyuIIIlV2Hm5ImLbKbfYnI")
...
auth_channel_1 = environ.get('AUTH_CHANNEL_1', '-1001821560097')
auth_channel_2 = environ.get('AUTH_CHANNEL_2', '-1001752626076')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel_1) if auth_channel_1 and id_pattern.search(auth_channel_1) else None
AUTH_CHANNELL = int(auth_channel_2) if auth_channel_2 and id_pattern.search(auth_channel_2) else None
