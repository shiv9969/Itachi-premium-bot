...
ST_VID = (environ.get("ST_VID", "https://graph.org/file/f3caab1fd396d5b72b81b.mp4")).split()
...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5069888600 5711059253').split()]
OWNER_USER_NAME = environ.get("OWNER_USER_NAME", "ArtisticDeveloper") # widout 👉 @
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002120136197').split()]
